...
def draw_top():
    ...
    # 右邊模式
    #draw_text("Keyboard", font_sm, x+w-16, y+18, TEXT_MAIN, align_right=True)
...
def draw_left_panel():
    ...
    # Coolant (移到底部，避免和 THR/BRK 文字重疊)
    #draw_text("Coolant", font_sm, x+26, y+h-60, TEXT_SUB)
    #draw_text(f"{int(temp_c):2d}°C", font_mid, x+26, y+h-30, TEXT_MAIN)
